...
public:
    ...
    bool HasTuyaConfig() { return has_tuya_config_; }
    ...
    bool CheckTuyaVersion(std::function<void(int progress, size_t speed)> callback = nullptr);
#endif
