...
private:
    ...
    void ReplyResult(const std::string& id_literal, const std::string& result);
    void ReplyError(const std::string& id_literal, const std::string& message);

    void GetToolsList(const std::string& id_literal, const std::string& cursor, bool list_user_only_tools);
    void DoToolCall(const std::string& id_literal, const std::string& tool_name, const cJSON* tool_arguments);
